      ...
      try {
        ...
        const updatedCclIpData = cclIpData.map((item) => {
          ...
          if (matchingResult) {
            return {
              ...item,
              concurrentCall: item.concurrentCall + matchingResult.concurrentCall,
            };
          }
          return item;
        });
  ...
  return (
    <>
      <Card className="analyticsDashboard">
        <Card.Body>
          <Card.Title>
            <h4 style={{ textTransform: "capitalize" }} className="border-bottom">
          ...
          <div className="analyticsTables">
            ...
            <div className="singleTable">
              ...
              <AnalyticsTable cclData={cclIpData} tableType={"cclIp"} totalUsage={totalUsage} />
            </div>
            {/* Second Table */}
            <div className="singleTable">
              <h6>CCL TDM Traffic</h6>
              <AnalyticsTable cclData={cclTdmData} tableType={"cclTdm"} totalUsage={totalUsage} />
            </div>
            {/* Grand Total */}
            <div className="singleTable">
              <AnalyticsTable cclData={[...cclIpData, ...cclTdmData]} tableType={"grandTotal"} totalUsage={totalUsage} />
            </div>
          </div>
